// =============================================================================
// Middleware — runs on every request to refresh the Supabase session cookie
// and enforce auth on protected routes.
// =============================================================================
...
export const config = {
  matcher: [
    // Run on all routes except static assets and API image optimization
